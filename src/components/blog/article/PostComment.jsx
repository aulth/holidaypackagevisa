            ...
            <div className="w-full rounded-lg p-4 ">
                ...
                <form onSubmit={publishRemark} className='mt-2 flex flex-col gap-4'>
                    <div className="w-full relative">
                        ...
                        <input value={data.name} onChange={handleOnChange} required name="name" type="text" placeholder='Enter your name' className='w-full p-1 border rounded border-gray-200  focus:outline focus:outline-red-400' />
                    </div>
                    <div className="w-full relative">
                        <label className="text-[10px] bg-white px-1 absolute -top-2 left-1 text-gray-500">Remark</label>
                        <textarea value={data.remark} onChange={handleOnChange} required name="remark" id="" placeholder='Type your thought..' className='w-full border border-gray-200 p-1 rounded focus:outline focus:outline-red-400'></textarea>
                    </div>
